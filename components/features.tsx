...
export default function Features() {
  ...
  return (
    <section className="relative md:flex md:items-center md:py-[0px] md:px-[25px]">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              ...
              <div className="mb-8 md:mb-0">
                <a
                  className={`flex items-center p-5 rounded border border-transparent transition duration-300 ease-in-out mb-3 ${
                    tab !== 1
                      ? "bg-zinc-900 shadow-md hover:shadow-lg"
                      : "bg-[#0E1015] border-[#006AFF]"
                  }`}
                  href="#0"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1 text-[#006AFF] text-lg">
                      Building the Simple ecosystem
                    </div>
                    <div className="text-[#858BA0] text-md">
                      Take collaboration to the next level with security and
                      administrative features built for teams.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-zinc-800 rounded-full shadow flex-shrink-0 ml-3">
                    <svg
